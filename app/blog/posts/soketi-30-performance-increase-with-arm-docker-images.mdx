...
authors:
  - name: Alex Renoki
    ...
    contact:
      github: rennokki
title: 30% performance increase with ARM Docker images
---


![Soketi: 30% performance increase with ARM Docker images](https://cdn.hashnode.com/res/hashnode/image/upload/v1642957819907/nlP5O8Vxr.png?w=1600&h=840&fit=crop&crop=entropy&auto=compress,format&format=webp)
