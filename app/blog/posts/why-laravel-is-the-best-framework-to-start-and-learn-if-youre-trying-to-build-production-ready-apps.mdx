---
image: "https://cdn.hashnode.com/res/hashnode/image/upload/v1649713713511/rrKYP2tjc.png"
draft: false
category: Laravel
tags:
  - Laravel
...
authors:
  - name: Alex Renoki
    ...
    contact:
      github: rennokki
title: Why I think Laravel is the best framework to start and learn if you're trying to build production-ready apps
---

![Why I think Laravel is the best framework to start and learn if you're trying to build production-ready apps](https://cdn.hashnode.com/res/hashnode/image/upload/v1649713713511/rrKYP2tjc.png)
...
At glance, I didn't know why. It was more of a [_je ne sais quoi_](https://www.merriam-webster.com/dictionary/je%20ne%20sais%20quoi). So in the need of seeking answers, I've put up a consistent list of why to pick Laravel as your next framework, no matter the size of your project.
...
```html
@component('mail::message') # Post Published A new post was published. ## {{
$post->title }} by {{ $post->user->name }} {{ $post->body }} @endcomponent
```
